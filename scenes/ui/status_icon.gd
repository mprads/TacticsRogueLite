...
const STATUS_ICON_SCENE = preload("uid://vh15m4qw1i4k")
...
static func create_new(new_status: Status) -> StatusIcon:
	var new_status_icon := STATUS_ICON_SCENE.instantiate()
	new_status_icon.status = new_status
